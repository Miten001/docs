...
- [ ] 1. Scaffold the NagrikSetu project
  - [ ] 1.1 Create the project structure and manifest
...
- [ ] 2. Implement the database layer
  - [ ] 2.1 Create `src/db.js` with schema initialization
...
- [ ] 6. Implement the Express server and REST endpoints
  - [ ] 6.1 Create `server.js` with static serving and app wiring
  ...
  - [ ] 6.2 Implement `POST /api/complaints`
  ...
  - [ ] 6.3 Implement `GET /api/complaints/:id`
  ...
  - [ ] 6.4 Add the terminal 404 handler and JSON error handler
...
- [ ] 9. Author the frontend pages (defect-free HTML)
  - [ ] 9.1 Create `public/index.html` (Home_Page)
  ...
  - [ ] 9.2 Create `public/report.html` (Report_Page)
  ...
  - [ ] 9.3 Create `public/track.html` (Track_Page)
  ...
  - [ ] 9.4 Create `public/dashboard.html` (Dashboard_Page)
  ...
  - [ ] 9.5 Create `public/about.html` (About_Page)
